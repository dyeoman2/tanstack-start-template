...
predeploy_aws_guardduty_webhook_shared_secret="$(get_json_value 'AWS_GUARDDUTY_WEBHOOK_SHARED_SECRET')"
predeploy_aws_storage_inspection_webhook_shared_secret="$(get_json_value 'AWS_STORAGE_INSPECTION_WEBHOOK_SHARED_SECRET')"
predeploy_aws_storage_role_arn_upload_presign="$(get_json_value 'AWS_STORAGE_ROLE_ARN_UPLOAD_PRESIGN')"
predeploy_aws_storage_role_arn_download_presign="$(get_json_value 'AWS_STORAGE_ROLE_ARN_DOWNLOAD_PRESIGN')"
predeploy_aws_storage_role_arn_promotion="$(get_json_value 'AWS_STORAGE_ROLE_ARN_PROMOTION')"
predeploy_aws_storage_role_arn_rejection="$(get_json_value 'AWS_STORAGE_ROLE_ARN_REJECTION')"
predeploy_aws_storage_role_arn_cleanup="$(get_json_value 'AWS_STORAGE_ROLE_ARN_CLEANUP')"
predeploy_aws_storage_role_arn_mirror="$(get_json_value 'AWS_STORAGE_ROLE_ARN_MIRROR')"
...
set_convex_env_if_present "AWS_GUARDDUTY_WEBHOOK_SHARED_SECRET" "${predeploy_aws_guardduty_webhook_shared_secret}"
set_convex_env_if_present "AWS_STORAGE_INSPECTION_WEBHOOK_SHARED_SECRET" "${predeploy_aws_storage_inspection_webhook_shared_secret}"
set_convex_env_if_present "AWS_STORAGE_ROLE_ARN_UPLOAD_PRESIGN" "${predeploy_aws_storage_role_arn_upload_presign}"
set_convex_env_if_present "AWS_STORAGE_ROLE_ARN_DOWNLOAD_PRESIGN" "${predeploy_aws_storage_role_arn_download_presign}"
set_convex_env_if_present "AWS_STORAGE_ROLE_ARN_PROMOTION" "${predeploy_aws_storage_role_arn_promotion}"
set_convex_env_if_present "AWS_STORAGE_ROLE_ARN_REJECTION" "${predeploy_aws_storage_role_arn_rejection}"
set_convex_env_if_present "AWS_STORAGE_ROLE_ARN_CLEANUP" "${predeploy_aws_storage_role_arn_cleanup}"
set_convex_env_if_present "AWS_STORAGE_ROLE_ARN_MIRROR" "${predeploy_aws_storage_role_arn_mirror}"
