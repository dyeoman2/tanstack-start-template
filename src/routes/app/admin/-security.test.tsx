...
function buildAuditReadiness(overrides?: Partial<Record<string, unknown>>) {
  return {
    ...
    latestImmutableExport: {
      endSequence: 18,
      exportedAt: Date.parse('2026-03-18T09:25:00.000Z'),
      headHash: 'head-hash-1',
      objectKey: 'audit-ledger/primary/000000000001-000000000018-head-hash-1.jsonl.gz',
    },
    archiveStatus: {
      required: true,
      configured: true,
      ...
      latestExportEndSequence: 18,
      lagCount: 0,
      driftDetected: false,
      lastVerifiedAt: Date.parse('2026-03-18T09:27:00.000Z'),
      lastVerifiedSealEndSequence: 18,
      lastVerificationStatus: 'verified',
      latestManifestObjectKey:
        'audit-ledger/primary/000000000001-000000000018-head-hash-1.manifest.json',
      latestPayloadObjectKey: 'audit-ledger/primary/000000000001-000000000018-head-hash-1.jsonl.gz',
      failureReason: null,
    },
    lastIntegrityFailure: null,
    lastSealAt: Date.parse('2026-03-18T09:20:00.000Z'),
    immutableExportHealthy: true,
    immutableExportLagCount: 0,
    metadataGaps: [],
    recentDeniedActions: [],
    recentExports: [
      {
