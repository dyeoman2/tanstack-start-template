...
predeploy_aws_s3_quarantine_bucket="$(get_json_value 'AWS_S3_QUARANTINE_BUCKET')"
predeploy_aws_s3_clean_bucket="$(get_json_value 'AWS_S3_CLEAN_BUCKET')"
predeploy_aws_s3_rejected_bucket="$(get_json_value 'AWS_S3_REJECTED_BUCKET')"
predeploy_aws_s3_mirror_bucket="$(get_json_value 'AWS_S3_MIRROR_BUCKET')"
predeploy_aws_s3_quarantine_kms_key_arn="$(get_json_value 'AWS_S3_QUARANTINE_KMS_KEY_ARN')"
predeploy_aws_s3_clean_kms_key_arn="$(get_json_value 'AWS_S3_CLEAN_KMS_KEY_ARN')"
predeploy_aws_s3_rejected_kms_key_arn="$(get_json_value 'AWS_S3_REJECTED_KMS_KEY_ARN')"
predeploy_aws_s3_mirror_kms_key_arn="$(get_json_value 'AWS_S3_MIRROR_KMS_KEY_ARN')"
predeploy_aws_file_serve_signing_secret="$(get_json_value 'AWS_FILE_SERVE_SIGNING_SECRET')"
predeploy_storage_broker_url="$(get_json_value 'STORAGE_BROKER_URL')"
predeploy_storage_broker_shared_secret="$(get_json_value 'STORAGE_BROKER_SHARED_SECRET')"
predeploy_storage_broker_access_key_id="$(get_json_value 'STORAGE_BROKER_ACCESS_KEY_ID')"
predeploy_storage_broker_secret_access_key="$(get_json_value 'STORAGE_BROKER_SECRET_ACCESS_KEY')"
predeploy_storage_broker_session_token="$(get_json_value 'STORAGE_BROKER_SESSION_TOKEN')"
predeploy_storage_worker_url="$(get_json_value 'STORAGE_WORKER_URL')"
predeploy_storage_worker_shared_secret="$(get_json_value 'STORAGE_WORKER_SHARED_SECRET')"
predeploy_convex_storage_callback_shared_secret="$(get_json_value 'CONVEX_STORAGE_CALLBACK_SHARED_SECRET')"
predeploy_convex_storage_decision_callback_shared_secret="$(get_json_value 'CONVEX_STORAGE_DECISION_CALLBACK_SHARED_SECRET')"
predeploy_convex_storage_decision_callback_shared_secret_previous="$(get_json_value 'CONVEX_STORAGE_DECISION_CALLBACK_SHARED_SECRET_PREVIOUS')"
predeploy_convex_document_result_callback_shared_secret="$(get_json_value 'CONVEX_DOCUMENT_RESULT_CALLBACK_SHARED_SECRET')"
predeploy_convex_document_result_callback_shared_secret_previous="$(get_json_value 'CONVEX_DOCUMENT_RESULT_CALLBACK_SHARED_SECRET_PREVIOUS')"
predeploy_convex_storage_inspection_callback_shared_secret="$(get_json_value 'CONVEX_STORAGE_INSPECTION_CALLBACK_SHARED_SECRET')"
predeploy_convex_storage_inspection_callback_shared_secret_previous="$(get_json_value 'CONVEX_STORAGE_INSPECTION_CALLBACK_SHARED_SECRET_PREVIOUS')"
...
set_convex_env_if_present "AWS_S3_QUARANTINE_BUCKET" "${predeploy_aws_s3_quarantine_bucket}"
set_convex_env_if_present "AWS_S3_CLEAN_BUCKET" "${predeploy_aws_s3_clean_bucket}"
set_convex_env_if_present "AWS_S3_REJECTED_BUCKET" "${predeploy_aws_s3_rejected_bucket}"
set_convex_env_if_present "AWS_S3_MIRROR_BUCKET" "${predeploy_aws_s3_mirror_bucket}"
set_convex_env_if_present "AWS_S3_QUARANTINE_KMS_KEY_ARN" "${predeploy_aws_s3_quarantine_kms_key_arn}"
set_convex_env_if_present "AWS_S3_CLEAN_KMS_KEY_ARN" "${predeploy_aws_s3_clean_kms_key_arn}"
set_convex_env_if_present "AWS_S3_REJECTED_KMS_KEY_ARN" "${predeploy_aws_s3_rejected_kms_key_arn}"
set_convex_env_if_present "AWS_S3_MIRROR_KMS_KEY_ARN" "${predeploy_aws_s3_mirror_kms_key_arn}"
set_convex_env_if_present "AWS_FILE_SERVE_SIGNING_SECRET" "${predeploy_aws_file_serve_signing_secret}"
set_convex_env_if_present "STORAGE_BROKER_URL" "${predeploy_storage_broker_url}"
set_convex_env_if_present "STORAGE_BROKER_SHARED_SECRET" "${predeploy_storage_broker_shared_secret}"
set_convex_env_if_present "STORAGE_BROKER_ACCESS_KEY_ID" "${predeploy_storage_broker_access_key_id}"
set_convex_env_if_present "STORAGE_BROKER_SECRET_ACCESS_KEY" "${predeploy_storage_broker_secret_access_key}"
set_convex_env_if_present "STORAGE_BROKER_SESSION_TOKEN" "${predeploy_storage_broker_session_token}"
set_convex_env_if_present "STORAGE_WORKER_URL" "${predeploy_storage_worker_url}"
set_convex_env_if_present "STORAGE_WORKER_SHARED_SECRET" "${predeploy_storage_worker_shared_secret}"
set_convex_env_if_present "CONVEX_STORAGE_CALLBACK_SHARED_SECRET" "${predeploy_convex_storage_callback_shared_secret}"
set_convex_env_if_present "CONVEX_STORAGE_DECISION_CALLBACK_SHARED_SECRET" "${predeploy_convex_storage_decision_callback_shared_secret}"
set_convex_env_if_present "CONVEX_STORAGE_DECISION_CALLBACK_SHARED_SECRET_PREVIOUS" "${predeploy_convex_storage_decision_callback_shared_secret_previous}"
set_convex_env_if_present "CONVEX_DOCUMENT_RESULT_CALLBACK_SHARED_SECRET" "${predeploy_convex_document_result_callback_shared_secret}"
set_convex_env_if_present "CONVEX_DOCUMENT_RESULT_CALLBACK_SHARED_SECRET_PREVIOUS" "${predeploy_convex_document_result_callback_shared_secret_previous}"
set_convex_env_if_present "CONVEX_STORAGE_INSPECTION_CALLBACK_SHARED_SECRET" "${predeploy_convex_storage_inspection_callback_shared_secret}"
set_convex_env_if_present "CONVEX_STORAGE_INSPECTION_CALLBACK_SHARED_SECRET_PREVIOUS" "${predeploy_convex_storage_inspection_callback_shared_secret_previous}"
