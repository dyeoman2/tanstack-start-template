...
const endpointAuditHandlers: readonly AuthAuditHandler[] = [
  ...
  },
  {
    owner: 'organization',
    kind: 'endpoint',
    name: 'organization.team-created',
    trigger: 'after:/organization/create-team',
    paths: ['/organization/create-team'],
    events: ['team_created'],
    handle: (state, ctx) => [
      createAuditRecord(
        ctx,
        state,
        {
          ...
          metadata: {
            ...
            teamId:
              normalizeOptionalString(state.response?.id) ??
              normalizeOptionalString(asRecord(state.response?.team)?.id),
          },
        },
        state.actorUserId,
      ),
  ...
  },
  {
    owner: 'organization',
    kind: 'endpoint',
    name: 'organization.team-updated',
    trigger: 'after:/organization/update-team',
    paths: ['/organization/update-team'],
    events: ['team_updated'],
    handle: (state, ctx) => [
      createAuditRecord(
        ctx,
        state,
        {
          ...
          metadata: {
            name: normalizeOptionalString(state.body.name),
            teamId: normalizeOptionalString(state.body.teamId),
          },
        },
        state.actorUserId,
      ),
  ...
  },
  {
    owner: 'organization',
    kind: 'endpoint',
    name: 'organization.team-deleted',
    trigger: 'after:/organization/remove-team',
    paths: ['/organization/remove-team'],
    events: ['team_deleted'],
    handle: (state, ctx) => [
      createAuditRecord(
        ctx,
  ...
  },
  {
    owner: 'organization',
    kind: 'endpoint',
    name: 'organization.team-member-added',
    trigger: 'after:/organization/add-team-member',
    paths: ['/organization/add-team-member'],
    events: ['team_member_added'],
    handle: (state, ctx) => {
      const targetUserId =
        normalizeOptionalString(state.body.userId) ?? normalizeOptionalString(state.body.memberId);
      return [
        createAuditRecord(
          ctx,
          state,
  ...
  },
  {
    owner: 'organization',
    kind: 'endpoint',
    name: 'organization.team-member-removed',
    trigger: 'after:/organization/remove-team-member',
    paths: ['/organization/remove-team-member'],
