...
const AUDIT_EVENT_FILTER_OPTIONS: TableFilterOption<'all' | OrganizationAuditEventType>[] = [
  ...
  // Members
  { label: 'Members: Added', value: 'member_added' },
  { label: 'Members: Removed', value: 'member_removed' },
  { label: 'Members: Role updated', value: 'member_role_updated' },
  { label: 'Members: Suspended', value: 'member_suspended' },
  { label: 'Members: Deactivated', value: 'member_deactivated' },
  { label: 'Members: Reactivated', value: 'member_reactivated' },
  // Invitations
  { label: 'Invites: Sent', value: 'member_invited' },
  { label: 'Invites: Accepted', value: 'invite_accepted' },
  { label: 'Invites: Rejected', value: 'invite_rejected' },
  { label: 'Invites: Cancelled', value: 'invite_cancelled' },
  // Domains
  { label: 'Domains: Added', value: 'domain_added' },
  { label: 'Domains: Verified', value: 'domain_verification_succeeded' },
  { label: 'Domains: Verification failed', value: 'domain_verification_failed' },
  { label: 'Domains: Token regenerated', value: 'domain_verification_token_regenerated' },
  { label: 'Domains: Removed', value: 'domain_removed' },
  // Enterprise Auth
  { label: 'Auth: Mode updated', value: 'enterprise_auth_mode_updated' },
  { label: 'Auth: Break-glass used', value: 'enterprise_break_glass_used' },
  { label: 'Auth: Login succeeded', value: 'enterprise_login_succeeded' },
  // SCIM
  ...
  { label: 'SCIM: Deprovision failed', value: 'scim_member_deprovision_failed' },
  // Bulk Operations
  ...
  // Admin & Organization
  { label: 'Admin: Policies updated', value: 'organization_policy_updated' },
  { label: 'Admin: Org created', value: 'organization_created' },
  { label: 'Admin: Org updated', value: 'organization_updated' },
  // Support Access
  ...
  // Audit & Export
  { label: 'Audit: Directory exported', value: 'directory_exported' },
  ...
  { label: 'Chat: Scan passed', value: 'chat_attachment_scan_passed' },
  { label: 'Chat: Scan failed', value: 'chat_attachment_scan_failed' },
  { label: 'Chat: PDF parse requested', value: 'pdf_parse_requested' },
  { label: 'Chat: PDF parse succeeded', value: 'pdf_parse_succeeded' },
  { label: 'Chat: PDF parse failed', value: 'pdf_parse_failed' },
  { label: 'Chat: Run completed', value: 'chat_run_completed' },
  { label: 'Chat: Run failed', value: 'chat_run_failed' },
  { label: 'Chat: Web search used', value: 'chat_web_search_used' },
];
