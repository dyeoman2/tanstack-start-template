...
predeploy_storage_broker_edge_assertion_secret="$(get_json_value 'STORAGE_BROKER_EDGE_ASSERTION_SECRET')"
predeploy_storage_broker_control_assertion_secret="$(get_json_value 'STORAGE_BROKER_CONTROL_ASSERTION_SECRET')"
...
set_convex_env_if_present "STORAGE_BROKER_EDGE_ASSERTION_SECRET" "${predeploy_storage_broker_edge_assertion_secret}"
set_convex_env_if_present "STORAGE_BROKER_CONTROL_ASSERTION_SECRET" "${predeploy_storage_broker_control_assertion_secret}"
